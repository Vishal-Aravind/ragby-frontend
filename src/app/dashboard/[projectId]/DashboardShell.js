...
const TOUR_STEPS = [
  ...
  },
  {
    ...
    icon: GitBranch,
    title: "Flows",
    content: "Build automated conversation flows — no code needed. Inside a flow, pick a node type from the panel on the right to add it, and click any node on the canvas to edit its settings.",
    access: "flows",
  },
  {
