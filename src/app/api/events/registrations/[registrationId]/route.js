...
export async function PUT(req, { params }) {
  ...
  const res = await fetch(`${BACKEND}/events/registrations/${registrationId}`, { method: "PUT", headers: { Authorization: `Bearer ${session.access_token}`, "Content-Type": "application/json" }, body: JSON.stringify(body) });
