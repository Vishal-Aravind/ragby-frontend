...
export async function POST(req) {
  ...
  const res = await fetch(`${BACKEND}/public/events/register`, { method: "POST", headers: { "Content-Type": "application/json", "X-Forwarded-For": visitorIp }, body: JSON.stringify(body) });
