...
export async function GET(req) {
  ...
  // check on top of RLS).
  //
  // getUser, not getSession: the role lookup below is an authorization
  // decision on user.id, and getSession returns the cookie's contents
  // without re-validating the JWT against the Auth server.
